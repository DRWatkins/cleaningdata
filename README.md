...
The files used for the assignment were:
======================================
...
then pulls information from files listed above.

The script then filters the data and outputs a tidy data set
which is organized by Subject and Activity.
